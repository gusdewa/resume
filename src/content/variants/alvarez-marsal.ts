...
Certified in cloud computing, DevOps, and agile leadership, with credentials from top hyperscalers and global executive programs.`,
  experience: [
    ...
    },
    {
      ...
      description: 'I help Sinarmas business units achieve transaction ready IT and accelerate value creation through AI-driven transformation. I bridge AI and digital technologies with business goals, focusing on solutions that deliver tangible, scalable results with investor-grade clarity.',
      highlights: [
    ...
    },
    {
      ...
      highlights: [
        ...
        'Championed adoption of agile methodologies with focus on value creation delivery and establishing clear sprint baselines and velocity metrics',
        ...
        'Established robust data pipelines with clear data governance and quality baselines for investor-grade analytics',
      ],
